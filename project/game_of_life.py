...
def count_neighbors(input_array, neighbor_sum, num_row, num_col):
    """This is a function to count 'on' neighbors for each cell in the array,
     ...
     :return: returns the count of total "on" neighbors for each cell,  and saves it in
     the 2D list neighbor_sum
     :rtype: integers ranging from 0 to 8
...
def apply_rules(input_array, neighbor_sum, num_row, num_col):
   """This is a function to define the rules of the "game of life" to each cell in the input_array,
    ...
    :param neighbor_sum: a 2D list(array) containing the total count of "on" neighbor cells for each cell in the input_array
    :type neighbor_sum:  a 2D list containing integers
    ...
    :return: returns a value of 1 or 0 to each cell in the input_array based on the defined rules.
    the rules are based on the integers in each cells of the neighbor_sum array
    :rtype: integer, 1 or 0
...
def print_grid(input_array, num_row, num_col):
    """This is a function to print the 2D list(array) after each iteration
     ...
     :return: prints out a 2D list with num_col columns and num)row rows. each cell of the input_array
      containing a value 1 would print a 'X' and every cell containing a value 0 would print a '-'
     :rtype: a 2D list with 'X's and '-'s
...
def main():
    """This is the main executable function of this script
     ...
     The user specifies the number of iterations for each called-in functions.
